...
interface NBlasInterface {
  ...
  daxpy(n: number, x: Float64Array, incx: number, y: Float64Array, incy: number): void;
  saxpy(n: number, x: Float32Array, incx: number, y: Float32Array, incy: number): void;
  ...
  idamin(n: number, x: Float64Array, incx: number): number;
  isamin(n: number, x: Float32Array, incx: number): number;
